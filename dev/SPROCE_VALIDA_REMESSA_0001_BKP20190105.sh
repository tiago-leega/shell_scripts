...
then
	...
	FNC_Log "FALHA : Mensageria não Informada ou não numerica. Registro rejeitado!"	
else
...
#Valida se a quantidade de registros do tipo E4 no arquivo Ã© igual ao informado no trailer
