...
v_QT_REG_E3_REJ=0000000
        ...
        echo "${v_TP_REGISTRO_RET}${p_CD_BANDEIRA_RET}${v_CD_CREDENCIADORA_RET}${v_CD_IDENT_ENVIO_RET}${v_NU_REMESSA_RET}${v_DT_ARQUIVO_RET}${v_STATUS_PROC_RET}${v_NUM_REG_INVALID_RET}${v_QT_REG_E1_ACP}${v_QT_REG_E1_REJ}${v_QT_REG_E2_ACP}${v_QT_REG_E2_REJ}${v_QT_REG_E3_ACP}${v_QT_REG_E3_REJ}" >> ${f_NOM_ARQ_RET}
}
...
v_LAST_LINE=$(tail -1 ${v_NOM_ARQ_FINAL} | cut -c1-23)"000000000000000000000000"
...
then
		...
		echo `echo ${v_FIRST_LINE} | cut -c 1-9`2`echo ${v_FIRST_LINE} | cut -c 11-48`"000000001" >> ${f_NOM_ARQ_HEADER}
